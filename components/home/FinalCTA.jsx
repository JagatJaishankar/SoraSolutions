...
export default function FinalCTA() {
  ...
  return (
    <section className="relative bg-[#0a0a0a] py-[120px] overflow-hidden">
      {/* Background glows */}
      <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-[#2362fd]/20 rounded-full blur-[150px] -translate-x-1/2 -translate-y-1/2 pointer-events-none" />
      <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-[#fd6600]/20 rounded-full blur-[150px] translate-x-1/2 translate-y-1/2 pointer-events-none" />
