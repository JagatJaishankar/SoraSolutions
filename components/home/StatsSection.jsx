...
function StatBlock({ stat, index }) {
  ...
  return (
    ...
    >
      <div className="text-5xl md:text-6xl font-black text-black pb-2 border-b-[3px] border-transparent bg-gradient-to-r from-[#2362fd] to-[#fd6600] bg-[length:100%_3px] bg-[position:0_100%] bg-no-repeat">
        {count}
        {stat.suffix}
      </div>
...
export default function StatsSection() {
  ...
  return (
    <motion.section
      ref={sectionRef}
      className="py-[100px] bg-gradient-to-r from-[#2362fd]/10 to-[#fd6600]/10"
      initial={{ opacity: 0 }}
