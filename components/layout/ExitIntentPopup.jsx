              ...
              <div className="bg-white/90 backdrop-blur-xl rounded-2xl p-8 relative">
                ...
                >
                  <input
                    ...
                    required
                    className="bg-white/70 backdrop-blur-md border border-white/20 rounded-xl outline-none transition-all duration-300 focus:border-primary/50 w-full px-4 py-3 text-sm text-black"
                  />
                  <input
                    type="email"
                  ...
                  <select
                    required
                    defaultValue=""
                    className="bg-white/70 backdrop-blur-md border border-white/20 rounded-xl outline-none transition-all duration-300 focus:border-primary/50 w-full px-4 py-3 text-sm text-black appearance-none"
                  >
